<?php
  ...
  $google_client_id 		= '786694245208.apps.googleusercontent.com';
  $google_client_secret = '8fiVIrqyFyvhrsRcjFcEzyXB';
  $google_redirect_url 	= 'http://kromaviews.no/pi/app/views/';
  $google_developer_key = 'AIzaSyDSaIEcJQ2LKwTXJClAgij9GVjvO2wtrZk';
  ...
  $gClient->setApplicationName('Views');
