  ...
  ageChart = function (width, height, values, labels, stroke) {
    ...
    var
      ...
      bar = function(cx, cy, r, startAngle, endAngle, params) {
        ...
        return paper.path(["M", xx1, yy1,
                           "L", x1, y1, 
                           "L", r, r, 0, +(endAngle - startAngle > 180), 0, x2, y2, 
                           "L", xx2, yy2, 
      ...
      process = function (j) {
        var 
          ...
          p   = bar(cx, cy, r, angle+90, angle + angleplus+90, {fill: "90-" + bcolor + "-" + color, stroke: stroke, "stroke-width": 0}),
