  ...
  x.subscribe("remove.me", handler);
  x.unsubscribe("remove.me", handler);
  ...
  x.subscribe("remove.me", handler);
  x.unsubscribe("remove", handler, true);
  x.publish("remove.me"); // nothing happens!

  // Unsubscribe everything!
  x.subscribe("remove", handler).subscribe("another.hierarchy", handler);
  x.unsubscribe("", true);
