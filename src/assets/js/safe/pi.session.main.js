// ensure we have a global app object
  ...
  π.app = {
    ...
    __initsocket     : null,
    __initialized    : false,
    __sessionserver  : window.location.host, //default values, override by passing options object to start() function
    __initport       : 8000,
    __inituri        : '/session',
    __sessionport    : 8101,
    __sessionuri     : '',
    ...
    __init : function (DEBUG) {
      ...
      if(DBG){
        ...
        host = 'ws://' + this.__sessionserver + ':' + this.__sessionport + this.__sessionuri;
