<?php
	...
	*/
	function format_javascript($data, $options = false, $c_string = "#e6db74", $c_comment = "#75715e", $c_keyword = "#f92672", $c_default = "#fff", $c_html = "#f92672", $flush_on_closing_brace = false) {
